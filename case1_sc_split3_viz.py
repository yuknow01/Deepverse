"""
case1_sc_split3_viz.py
─────────────────────
Case 1 SC-wise split3 (batch=64) 학습 결과 시각화

사용법:
    python case1_sc_split3_viz.py              # N_SCENES=1000
    python case1_sc_split3_viz.py --scenes 500
"""
...
def main():
    ...
    title      = f"{SPLIT_TAG}  |  batch=64  |  scenes={N}"
